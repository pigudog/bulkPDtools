...
```{r}
save(DEG3,file = "deg/DESeq2_deg_data3.Rdata")
write.table(DEG3,row.names=TRUE,col.names=TRUE,sep=",","deg/DESeq2_degPCvsCT_data3.csv")
```
...
```
```{r}
mitodeg3 <- intersect_gene
save(mitodeg3,file = "mito/mitodeg3.Rdata")
write.table(mitodeg3,file ='mito/mitodeg3.txt',row.names = F,col.names = F,quote=F)
```
...
length(intersect_gene)
mitodeg3_up <- intersect_gene
save(mitodeg3_up,file = "mito/mitodeg3_up.Rdata")
write.table(mitodeg3_up,file ='mito/mitodeg3_up.txt',row.names = F,col.names = F,quote=F)
```
```{r}
...
length(intersect_gene)
mitodeg3_down <- intersect_gene
save(mitodeg3_down,file = "mito/mitodeg3_down.Rdata")
write.table(mitodeg3_down,file ='mito/mitodeg3_down.txt',row.names = F,col.names = F,quote=F)
```
